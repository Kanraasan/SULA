                ...
                <Card key={report.id} className="overflow-hidden border-border bg-card">
                  <div className="aspect-video w-full bg-muted">
                    {report.complaint_image ? (
                      <img src={report.complaint_image.startsWith('http') ? report.complaint_image : `http://localhost:3245/uploads/${report.complaint_image}`} alt={report.complaint_title} className="h-full w-full object-cover" />
                    ) : (
